export const theme = {
  "root": {
    ...
    "inner": {
      "base": "px-4 py-2 w-full mx-auto flex flex-wrap items-center justify-between",
      "fluid": {
        "on": "",
        "off": "container"
      }
  ...
  "collapse": {
    "base": "w-full md:block md:w-auto bg-black md:bg-transparent",
    "list": "mt-4 md:gap-2 flex flex-col md:mt-0 md:flex-row md:text-sm md:font-medium",
    "hidden": {
      "on": "hidden",
      "off": ""
    }
